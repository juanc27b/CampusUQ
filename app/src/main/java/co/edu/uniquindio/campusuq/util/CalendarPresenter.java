...
public class CalendarPresenter {
    ...
    public static ArrayList<CalendarItem> getCalendarItems(String categoryName, Context context) {
    ...
    public static ArrayList<CalendarDetailItem> getCalendarDetailItems(String event, String category, Context context) {
