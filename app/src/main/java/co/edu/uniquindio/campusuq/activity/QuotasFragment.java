...
public class QuotasFragment extends DialogFragment implements View.OnClickListener {
    ...
    private static final String FRAGMENT_QUOTAS = "fragment_quotas", INDEX = "index";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") View view = quotasActivity.getLayoutInflater().inflate(fragment_quotas? R.layout.fragment_quotas : R.layout.fragment_dialog, null);
                ...
                if (Utilities.haveNetworkConnection(quotasActivity)) {
                    if (fragment_quotas) {
                        ...
                        if (modify.isChecked()) {
                            ...
                            intent.putExtra(QuotasSQLiteController.columns[0], (Integer) q.get_ID());
                            intent.putExtra(QuotasSQLiteController.columns[1], q.getType());
                            intent.putExtra(QuotasSQLiteController.columns[2], q.getName());
                            intent.putExtra(QuotasSQLiteController.columns[3], String.valueOf(q.getQuota()));
                    ...
                    Toast.makeText(quotasActivity, getString(R.string.no_internet), Toast.LENGTH_SHORT).show();
                }
