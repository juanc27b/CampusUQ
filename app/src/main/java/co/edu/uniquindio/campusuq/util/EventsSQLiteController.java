...
public class EventsSQLiteController {
    ...
    public static final String CAMPOS_TABLA[] = new String[]{"_ID", "Nombre"};

    public static final String NOMBRE_CATEGORIA = "Evento_Categoria";
    public static final String CAMPOS_CATEGORIA[] = new String[]{"_ID", "Abreviacion", "Nombre"};

    public static final String NOMBRE_PERIODO = "Evento_Periodo";
    public static final String CAMPOS_PERIODO[] = new String[]{"_ID", "Nombre"};

    public static final String NOMBRE_FECHA = "Evento_Fecha";
    public static final String CAMPOS_FECHA[] = new String[]{"_ID", "Tipo", "Fecha"};

    public static final String NOMBRE_RELACION = "Evento_Relacion";
    ...
    public ArrayList<EventPeriod> selectPeriod(String selection, String[] selectionArgs) {
