...
public class ProgramsSQLiteController {
    ...
    public static final String NOMBRE_TABLA = "Programa";
    ...
    public static final String NOMBRE_CATEGORIA = "Programa_Categoria";
    public static final String CAMPOS_CATEGORIA[] = new String[]{"_ID", "Nombre"};

    public static final String NOMBRE_FACULTAD = "Programa_Facultad";
    public static final String CAMPOS_FACULTAD[] = new String[]{"_ID", "Nombre"};
